...
const Experience = () => {
    ...
    <div className="flex mt-4 gap-12">
       ...
       <div className="">
       <h3 className="text-2xl font-semibold">Samoo Architects & Engineers</h3>
    ...
    <div className="flex mt-4 gap-12">
        ...
        <div className="border-r-2"></div>
       <div className="">
       <h3 className="text-2xl font-semibold">Foster & Partners</h3>
        <p> dolor sit amet, consectetur dipiscing elit. Proin a ipsum tellus.  Interdum et malesuada fames ac ante ipsum <br /> primis in faucibus. Proin a ipsum tellus.  Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
       </div>
    </div>
    ...
    <div className="flex mt-4 gap-12">
        ...
        <div className="border-r-2"></div>
       <div className="">
       <h3 className="text-2xl font-semibold">Skidmore Owings & Merrill</h3>
        <p> dolor sit amet, consectetur dipiscing elit. Proin a ipsum tellus.  Interdum et malesuada fames ac ante ipsum <br /> primis in faucibus. Proin a ipsum tellus.  Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
       </div>
    </div>
