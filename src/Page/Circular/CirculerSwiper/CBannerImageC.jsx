    ...
    return (
        <div className="relative ">
            <div className="absolute w-full md:w-1/2 grid justify-center items-center top-0 bottom-0 p-5">
                <div className="lg:w-1/2 mx-auto space-y-5 grid-flow-col text-center z-10 mb-20">
                    <h3 className="text-4xl font-bold text-[#666699]">
                        Empower Your Future: Explore Opportunities
                    </h3>
                    <p className="leading-7 text-wrap text-black font-semibold text-lg">
                        Take the next step in your professional journey. Browse through our latest job listings and seize the opportunity.
                    </p>
            ...
            <img
                ...
                src="https://i.ibb.co/VS4PRzG/hire-3.jpg"
                alt="swiperD"
            />
            ...
            <div className="flex flex-col md:flex-row justify-center items-center bg-[#666699] p-5 ">
                <h4 className="md:w-4/5 text-white font-semibold text-xl md:text-3xl z-10">
                    Connect with top employers and unlock exciting job opportunities using EasyRecruit Latest Job Circular Features.</h4>
            </div>
