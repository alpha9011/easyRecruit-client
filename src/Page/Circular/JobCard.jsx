          ...
          >
            ...
            <div className="flex items-start mb-4 p-5">
              ...
              <div className="space-y-2">
                ...
                <Link to={`/jobapply/${_id}`} className=" px-3 py-2 bg-blue-700 text-white  rounded-md hover:bg-slate-800 hover:-translate-y-[2px] duration-75 cursor-pointer flex items-center w-fit gap-2">Apply Now <FaArrowRightLong></FaArrowRightLong> </Link>
              </div>
            </div>
          </div>
