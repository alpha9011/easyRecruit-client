...
const CustomerFeedback = () => {
  ...
  const onSubmit = async (data) => {
    ...
    axiosPublic.post("/feedback", feedbackInfo).then((res) => {
    ...
    return (
      <div className="flex items-center justify-center relative ">
        ...
        <div className="max-w-2xl text-center rounded-tr-3xl transition-transform duration-500 transform origin-center bg-yellow-50 hover:shadow-2xl   border-t-8 border-r-8 border-blue-400">
          <div className="p-6">
            <h2 className="text-2xl text-left font-semibold mb-2 flex">
              <span>
                <BsStars className="text-yellow-300 mt-1" />
              </span>{" "}
              We would Love To Here From You
            </h2>
            <p className="text-left font-normal text-lg">
              <span>
                <FaHandSparkles className="text-yellow-300  text-xl mt-1" />
              </span>{" "}
              Hey there! You are Here because you are an valued EasyRecruit
              visitor . We'd love to receive your UI experience feedback so that
              we can improve our UI and make user friendly for you and others
            </p>
          </div>
          <form className="">
            <div>
              ...
              <div className="flex justify-center space-x-2 mt-5">
                {[1, 2, 3, 4, 5].map((value) => (
                  <button
                    ...
                    className={`text-4xl hover:cursor-pointer hover:scale-110 hover:text-yellow-400  focus:outline-none ${
            ...
            <div className="p-5">
              ...
              <textarea
                ...
                className="mt-1 input border-sky-400 border-1 w-full"
                id=""
                cols="15"
                rows="3"
                placeholder="What would like to tell usk"
                required
              ></textarea>
            </div>
          </form>
          <button
            disabled
            className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mb-10"
          >
            Submit
          </button>
        </div>
    ...
    <div className="flex items-center justify-center relative p-5">
      ...
      <div className="max-w-2xl text-center rounded-tr-3xl transition-transform duration-500 transform origin-center bg-yellow-50 hover:shadow-2xl   border-t-8 border-r-8 border-sky-300 ">
        <div className="p-5 m-2">
          <h2 className="text-2xl text-left font-semibold mb-2 flex gap-2">
            {" "}
            <span>
              <BsStars className="text-yellow-300 mt-1" />
            </span>{" "}
          ...
          <p className="text-left font-light text-lg flex gap-2">
            {" "}
            <span>
              <FaHandSparkles className="text-yellow-300  text-xl mt-1" />
            </span>{" "}
            Hey there! You are Here because you are an valued EasyRecruit
            customer. We'd love to receive your feedback so that we can improve
            for you and others
          </p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="">
          ...
          <div className="p-5 ">
            <button type="submit">
              <PrimaryButton buttonText="Please Submit"></PrimaryButton>
            </button>
          </div>
        </form>
      </div>
