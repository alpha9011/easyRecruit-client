...
const PopularCategoriy = () => {
    return (
        ...
        <div className="max-w-7xl mx-auto bg-[#f2f9d8] p-12 my-12" >
            
            <div className="flex-col md:flex lg:flex gap-56">
                ...
                <div>
                    ...
                    <button className="border-b-2 flex items-center mt-4 text-[#98bd00]">Explore all fields <FaAngleRight /></button>
                </div>
            </div>


            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 mx-auto gap-12">
