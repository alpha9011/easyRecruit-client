    ...
    return (
        <div className="bg-slate-100 py-10 rounded-tr-[150px] rounded-bl-[150px]">
            <div className="max-w-screen-xl mx-auto my-20 flex flex-col lg:flex-row gap-60 lg:gap-16">
                <div className="lg:w-1/2 relative px-5" data-aos="fade-right" data-aos-duration="1000">
                ...
                <div className="lg:w-1/2 px-5" data-aos="fade-left" data-aos-duration="1000">
            ...
            <div className="max-w-screen-xl mx-auto my-20 flex flex-col-reverse lg:flex-row gap-60 lg:gap-16 lg:mb-40">
                <div className="lg:w-1/2 px-5" data-aos="fade-right" data-aos-duration="1000">
                ...
                <iframe height="350" src="https://www.youtube.com/embed/8bSdDa_2H1w?si=ZFLlyLDgHPW4zwf_&amp;controls=0" className="border p-1 max-[425px]:w-96 min-[426px]:w-[600px] -mb-40 lg:-mb-1" data-aos="fade-left" data-aos-duration="1000"></iframe>
            </div>
