...
const PriceCard = () => {
  ...
  return (
    <div>
        ...
        >
          <Card className="max-w-sm h-[710px] transition-transform duration-500 transform origin-center hover:translate-y-[-2rem]">
            ...
            <div className="flex items-baseline text-gray-900 dark:text-white">
              ...
              <span className="text-7xl font-semibold italic tracking-tight">
                79
              </span>
              <span className="ml-1 font-normal text-gray-500 dark:text-gray-400">
                /month <p>when billed annually*</p>
              </span>
            </div>
            {/* border */}
            ...
            <div>
              ...
              <div className="flex flex-row justify-around">
                ...
                <div className="flex flex-col items-center bg-slate-100 py-4 w-36 rounded-sm">
                  ...
                  <p className="text-xs font-bold">
                    3 Open Jobs<span className="text-blue-400"> *</span>
                  </p>
                </div>
              </div>
              ...
              {/* extra info */}
              <div>
                <p className="text-sm text-gray-600 mb-1 leading-loose">
                  <span className="text-cyan-500">* </span>Post up to 3 jobs at
                  once, add more jobs for just $9 per job per month.
                </p>
                <p className="text-sm text-gray-600 mb-1 leading-loose">
                  <span>* </span>Hero price for staffing companies is
                  $116/month.
                </p>
              </div>
            </div>
            ...
            <Link to="/membership" className="mt-auto">
              <button
                type="button"
                className="flex-grow inline-flex w-full justify-center rounded-lg bg-cyan-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-white hover:text-cyan-500 border-2 duration-500 border-cyan-500 focus:outline-none focus:ring-4 focus:ring-cyan-200 dark:focus:ring-cyan-900 "
              >
                Choose plan
              </button>
            </Link>
        ...
        >
          <Card className="max-w-sm h-[710px] transition-transform duration-500 transform origin-center hover:translate-y-[-2rem]">
            ...
            <div>
              ...
              <div>
                <p className="text-sm text-gray-600 mb-1 leading-loose">
                  You can add additional features that are not included with
                  PLUS. View our Add-Ons below for more information.
                </p>
              </div>
            </div>
            {/* button */}
      ...
      {/* Buttons */}
      <div
        className="w-full flex flex-col justify-center items-center gap-5 my-16"
        data-aos="fade-up"
        data-aos-duration="1000"
      >
        ...
        <div className="flex gap-5">
          ...
          <PrimaryButton buttonText="Try it Free "></PrimaryButton>
        </div>
      </div>
    </div>
  );
